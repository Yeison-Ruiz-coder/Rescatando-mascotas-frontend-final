...
import FundacionCard from '../../../components/common/Mascotas/FundacionCard';
  ...
  const fetchMascotaDetalle = async () => {
    try {
      ...
      if (response.data.success) {
        ...
        console.log('🐾 Vacunas desde API:', data.vacunas);
        console.log('🐾 Fundación desde API:', data.fundacion);
        console.log('🐾 Razas desde API:', data.razas);
    ...
    <div className="mascota-detalle-page">
      <div className="detalle-container">
        ...
        <div className="detalle-grid">
          {/* Columna izquierda - Galería + Fundación */}
          <div className="detalle-gallery">
            ...
            {/* ✅ Fundación movida AQUÍ - debajo de la galería */}
            <FundacionCard 
              fundacion={fundacion} 
          ...
          <div className="detalle-info">
            ...
            {/* Salud y Cuidados (incluye vacunas) */}
            <SaludCuidados 
              mascota={mascota}
              vacunas={vacunas}
              t={t}
