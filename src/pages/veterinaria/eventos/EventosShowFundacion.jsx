...
const FundacionEventosShow = () => {
    ...
    if (loading) {
        return (
            <div className="rmf-eventos-show-page">
                <ProfileBanner
                    user={{
                        nombre: fundacionName,
                        avatar: fundacionAvatar,
                        titulo: t('cargando_evento'),
                        solicitudes: 0,
                        adopciones: 0,
                        eventos: 0,
                    }}
            ...
            <div className="rmf-eventos-show-page">
                ...
                <div className="rmf-eventos-show-container">
                    <div className="rmf-error-container">
                        ...
                        <Link to="/veterinaria/eventos" className="rmf-btn-back">{t('btn_volver')}</Link>
                    </div>
                </div>
            </div>
        );
        ...
        <div className="rmf-eventos-show-page">
            <ProfileBanner
                user={{
                    nombre: fundacionName,
                    avatar: fundacionAvatar,
                    titulo: evento.nombre_evento || t('evento'),
                    solicitudes: 0,
                    adopciones: 0,
                    eventos: 1,
                }}
            ...
            <div className="rmf-eventos-show-container">
                <div className="rmf-actions-bar">
                    <Link to="/veterinaria/eventos" className="rmf-btn-back">
                        <ArrowLeft size={18} />
                        {t('btn_volver')}
                    </Link>
                    <div className="rmf-show-actions">
                        <Link to={`/veterinaria/eventos/${id}/editar`} className="rmf-btn-edit">
                            <Edit size={18} />
                            {t('botones.editar')}
                        </Link>
