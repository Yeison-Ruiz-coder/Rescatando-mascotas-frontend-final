...
const FundacionEventosCreate = () => {
  ...
  // Referencias separadas para cada input de fecha
  ...
  // Función para abrir calendario de inicio
  ...
  // Función para abrir calendario de fin
  ...
  return (
    <div className="admin-eventos-form-container">
      <div className="back-button-wrapper">
        <Link to="/fundacion/eventos" className="btn-back-gradient">
          <ArrowLeft size={18} />
          {t("back_to_events")}
        </Link>
      </div>
