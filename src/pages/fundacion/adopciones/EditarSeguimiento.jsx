...
const EditarSeguimiento = () => {
  ...
  const [fechaSeguimientoDate, setFechaSeguimientoDate] = useState(null);
  ...
  const fetchSeguimiento = async () => {
    try {
      ...
      const fechaSeg = data.fecha_seguimiento ? new Date(data.fecha_seguimiento) : null;
      setFechaSeguimientoDate(fechaSeg);
      
      const proxSeg = data.proximo_seguimiento ? new Date(data.proximo_seguimiento) : null;
      setProximoSeguimientoDate(proxSeg);
      ...
      <div className="cs-content">
        <div className="bento-container">
          <div className="cs-header">
            ...
            <p className="cs-subtitle">#{id} - {t('editando')}</p>
          </div>
            ...
            <div className="cs-form-grid">
              ...
              {fotosExistentes.length > 0 && (
                <div className="cs-form-group full">
                  ...
                  <div className="cs-fotos-grid">
                    {fotosExistentes.map((foto, index) => (
                      <div key={index} className="cs-foto-item">
                        <img src={foto} alt={`Foto ${index + 1}`} />
                        <button
                          type="button"
                          className="cs-foto-eliminar"
