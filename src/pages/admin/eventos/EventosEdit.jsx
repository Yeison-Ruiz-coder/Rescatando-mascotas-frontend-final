    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (error.response?.data?.errors) {
                ...
                alert('Error al actualizar el evento global');
            }
        } finally {
            setSaving(false);
        }
        ...
        <div className="eventos-form-container">
            <div className="form-card">
                <div className="form-card-header admin-header">
                    <h2>Editar Evento Global</h2>
                    <p>Actualiza los datos del evento global</p>
                </div>
                <div className="form-card-body">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="form-actions">
                            <button type="button" onClick={() => navigate('/admin/eventos')} className="btn-secondary" disabled={saving}>Cancelar</button>
