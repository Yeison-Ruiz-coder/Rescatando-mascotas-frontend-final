        ...
        <div className="eventos-show-container">
            <div className="show-card">
                <div className="show-header">
                    <Link to="/admin/eventos" className="back-button"><ArrowLeft size={20} /> Volver a eventos globales</Link>
                    <div className="show-actions">
                        <Link to={`/admin/eventos/${id}/editar`} className="btn-edit-show"><Edit size={18} /> Editar</Link>
