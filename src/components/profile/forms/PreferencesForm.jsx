    ...
    <form onSubmit={handleSubmit}>
      <div className="form-group">
        ...
        <div className="preferences-buttons">
          <button 
            type="button" 
            className={`btn-${formData.idioma === 'es' ? 'primary' : 'outline'}-global btn-sm`} 
          ...
          <button 
            type="button" 
            className={`btn-${formData.idioma === 'en' ? 'primary' : 'outline'}-global btn-sm`} 
      ...
      <div className="form-group">
        ...
        <div className="preferences-buttons">
          <button 
            type="button" 
            className={`btn-${formData.tema === 'light' ? 'primary' : 'outline'}-global btn-sm`} 
          ...
          <button 
            type="button" 
            className={`btn-${formData.tema === 'dark' ? 'primary' : 'outline'}-global btn-sm`} 
        ...
        <div className="preferences-checkboxes">
          ...
          <label className="form-checkbox">
            <input 
              type="checkbox" 
              name="sms" 
              checked={formData.preferencias_notificaciones.sms} 
              onChange={handleChange} 
            />
